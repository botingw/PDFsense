...
(*1. This executable read  "savedata_config" and save data of f(x, Q) of all flavours (bbar~b) into /PDFDataDir/PDFDataFile\[AliasDelimiter]\[AliasDelimiter]*)
...
Print["data filename = ",FxQSameptDir<>FxQSameptFile];
Print["data label format example: ",fxQsamept2class[[1,1]][["label"]] ];
Print["data format example: ",fxQsamept2class[[1,1]][["data"]][[1]] ];
