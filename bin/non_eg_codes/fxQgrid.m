...
(* ::Section:: *)
(*Introduction of making grid PDF*)
...
(**)
(*\[Dash] ./quick_data/fxQ_{$methods}_{$PDFname}_x{$Nx}_{$NQ}.m, where $PDFname = PDFname, where $methods = "samept", "grid", "xgrid", $PDFname = PDFname, ex: CT14NNLO*)
(**)
...
{PDFsetDir,PDFsetmethod,(*ExptIDList*)dummy1,datalistFile,FxQGridDir,FxQGridFile,(*FxQSameptDir*)dummy2,(*FxQSameptFile*)dummy3,(*CorrDataDir*)dummy4,(*CorrDataFile*)dummy5,GridNx,GridNQ}=
...
Qmin=2.0;Qmax=2000.0;NQ=GridNQ;
{Qzmin,Qzmax}={Log[Qmin],Log[Qmax]}
Qzs=Table[Qzmin+iQ*(Qzmax-Qzmin)/NQ,{iQ,0,NQ}];
Qs=Exp[Qzs]
...
(* ::Input::Initialization:: *)
xQLF=Table[LF[xs[[ix+1]],Qs[[iQ+1]] ],{iQ,0,NQ},{ix,0,Nx}]//Flatten;
