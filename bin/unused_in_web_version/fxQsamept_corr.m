...
(**)
(*\[Dash] ./quick_data/{$obs}_samept_data_{$PDFname}.dat, where $PDFname = PDFname, ex: CT14NNLO, $obs = "corr", "dRcorr", "dR", "residual", "residualNset", "expterror"*)
(**)
