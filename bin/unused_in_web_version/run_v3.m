...
uservalueclass=
Table[
tmpclass=residualNsetdataclass[[iexpt]];
tmpclass[["data"]]=tmpclass[["data"]]/.LF[a__]:>LF[{a}[[1]],{a}[[2]],Sequence@@UserArgValue];
tmpclass,
{iexpt,1,Length[residualNsetdataclass]}
];
(*make corr(residual, uservalue)*)
usercorrclass=
Table[
corrfxQdtaobs[residualNsetdataclass[[i]],uservalueclass[[i]] ],
{i,1,Length[residualNsetdataclass]}
];
...
userdRcorrclass=
Table[
dRcorrfxQdtaobs[residualNsetdataclass[[i]],uservalueclass[[i]] ],
{i,1,Length[residualNsetdataclass]}
];
...
Table[
corrdataclass[[iexpt]]=Append[corrdataclass[[iexpt]],usercorrclass[[iexpt]] ];
dRcorrdataclass[[iexpt]]=Append[dRcorrdataclass[[iexpt]],userdRcorrclass[[iexpt]] ];
"dummy",
{iexpt,1,Length[corrdataclass]}
];
(*update fmax*)
fmax=Length[corrdataclass[[1]] ];
];
...
Table[
If[
corrdataclass[[iexpt,1]][["exptinfo","exptid"]]==exptlist[[iexptlist]],
expttakeindex=Append[expttakeindex,iexpt];
(*make exptlistfinal*)
exptlistfinal=Append[exptlistfinal,exptlist[[iexptlist]] ];
];
"dummy"
,{iexptlist,1,Length[exptlist]},{iexpt,1,Length[corrdataclass]}
];
expttakeindex;
...
corrdataclassfinal=
Table[
corrdataclass[[expttakeindex[[iexpttakeindex]] ]],
{iexpttakeindex,1,Length[expttakeindex]}
];
dRcorrdataclassfinal=
Table[
dRcorrdataclass[[expttakeindex[[iexpttakeindex]] ]],
{iexpttakeindex,1,Length[expttakeindex]}
];
expterrordataclassfinal=
Table[
expterrordataclass[[expttakeindex[[iexpttakeindex]] ]],
{iexpttakeindex,1,Length[expttakeindex]}
];
residualdataclassfinal=
Table[
residualdataclass[[expttakeindex[[iexpttakeindex]] ]],
{iexpttakeindex,1,Length[expttakeindex]}
];
dRdataclassfinal=
Table[
dRdataclass[[expttakeindex[[iexpttakeindex]] ]],
{iexpttakeindex,1,Length[expttakeindex]}
];

residualNsetdataclassfinal=
Table[
residualNsetdataclass[[expttakeindex[[iexpttakeindex]] ]],
{iexpttakeindex,1,Length[expttakeindex]}
];
